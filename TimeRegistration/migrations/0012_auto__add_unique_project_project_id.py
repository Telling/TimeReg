...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'TimeRegistration_project', ['project_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['project_id']
        db.delete_unique(u'TimeRegistration_project', ['project_id'])
    ...
    models = {
        ...
        u'TimeRegistration.project': {
            ...
            'project_id': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
