...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TimeRegistration.project_phase'
        db.add_column(u'TimeRegistration_timeregistration', 'project_phase',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['TimeRegistration.Project_phase'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TimeRegistration.project_phase'
        db.delete_column(u'TimeRegistration_timeregistration', 'project_phase_id')
