...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeRegistration.description'
        db.alter_column(u'TimeRegistration_timeregistration', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'TimeRegistration.description'
        db.alter_column(u'TimeRegistration_timeregistration', 'description', self.gf('django.db.models.fields.CharField')(default='db update', max_length=100))
