...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'TimeRegistration_project', 'status')

        # Adding field 'Project.is_active'
        db.add_column(u'TimeRegistration_project', 'is_active',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'TimeRegistration_project', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Project.is_active'
        db.delete_column(u'TimeRegistration_project', 'is_active')
