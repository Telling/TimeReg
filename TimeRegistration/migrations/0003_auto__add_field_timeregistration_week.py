...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeRegistration.week'
        db.add_column(u'TimeRegistration_timeregistration', 'week',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeRegistration.week'
        db.delete_column(u'TimeRegistration_timeregistration', 'week')
