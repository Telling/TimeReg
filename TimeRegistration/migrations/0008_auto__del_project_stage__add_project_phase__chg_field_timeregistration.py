...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Project_phase'
        db.create_table(u'TimeRegistration_project_phase', (
        ...
        db.send_create_signal(u'TimeRegistration', ['Project_phase'])

        # Adding M2M table for field users on 'Project_phase'
        m2m_table_name = db.shorten_name(u'TimeRegistration_project_phase_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project_phase', models.ForeignKey(orm[u'TimeRegistration.project_phase'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_phase_id', 'user_id'])


        # Changing field 'TimeRegistration.project_stage'
        db.alter_column(u'TimeRegistration_timeregistration', 'project_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['TimeRegistration.Project_phase'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Project_phase'
        db.delete_table(u'TimeRegistration_project_phase')

        # Removing M2M table for field users on 'Project_phase'
        db.delete_table(db.shorten_name(u'TimeRegistration_project_phase_users'))


        # Changing field 'TimeRegistration.project_stage'
        db.alter_column(u'TimeRegistration_timeregistration', 'project_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['TimeRegistration.Project_stage'], null=True))
    ...
    models = {
        ...
        u'TimeRegistration.project_phase': {
            'Meta': {'object_name': 'Project_phase'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'project': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['TimeRegistration.Project']", 'unique': 'True'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'project_phase'", 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        },
        u'TimeRegistration.timeregistration': {
            ...
            'project_stage': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['TimeRegistration.Project_phase']", 'null': 'True', 'blank': 'True'}),
