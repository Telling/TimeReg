...
urlpatterns = patterns(
    ...
    url(r'^tools/projects/close_project/$',
        'TimeRegistration.views.close_project'),
    url(r'^tools/projects/open_project/$',
        'TimeRegistration.views.open_project', name='project'),
    url(r'^tools/projects/open_project_phase/$',
        'TimeRegistration.views.open_project_phase', name='project_phase'),
    url(r'^tools/projects/close_project_phase/$',
        'TimeRegistration.views.close_project_phase'),
